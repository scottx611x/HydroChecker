...
echo "<br>";
echo "<div >";
echo "<a href='https://plot.ly/~scottx611x1c74/10/' target='_blank' 
title='Top Hydrophobic Proteins ' . $select .
' style='display: block; text-align: center;'><img src='https://plot.ly/~scottx611x1c74/10.png' 
alt='Top Hydrophobic Proteins  ' 
. $select . ' style='max-width: 85%;'  onerror='this.onerror=null;
this.src='https://plot.ly/404.png';' /><br><br></a><script 
data-plotly='scottx611x1c74:10' src='https://plot.ly/embed.js' async></script>";
echo "</div>";
echo "<br>";
...
<div align="center">
<footer style="color:white;font-family: Raleway;">Scott Ouellette ©2015 all rights reserved
<a href = "index.html" style="color:white;"> www.scott-ouellette.com</a></footer>
</div>
</html>
